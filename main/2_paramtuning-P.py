...
configs_mismatch2=[
    {"name":"p_line=1/8, p=1/8", "size":size, "p_line":1/8, "p":1/8, "alpha":alpha, "beta":beta, "gamma":gamma, "num_batches":num_batches, "settling_steps":settling_steps},
    {"name":"p_line=1/8, p=1/4", "size":size, "p_line":1/8, "p":1/4, "alpha":alpha, "beta":beta, "gamma":gamma, "num_batches":num_batches, "settling_steps":settling_steps},
    {"name":"p_line=1/8, p=1/2", "size":size, "p_line":1/8, "p":1/2, "alpha":alpha, "beta":beta, "gamma":gamma, "num_batches":num_batches, "settling_steps":settling_steps},
]
